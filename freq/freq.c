...
main(){
	...
	unsigned long time,cycle_1_l,cycle_2_l,cycle_1_h,cycle_2_h;
	unsigned long cycle_1,cycle_2;
	double cpufreq;
	while(1){
		...
		cycle_1 = ((unsigned long)cycle_1_h << 32) | (cycle_1_l & 0x0fffffff);
		cycle_2 = ((unsigned long)cycle_2_h << 32) | (cycle_2_l & 0x0fffffff);
