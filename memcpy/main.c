...
int basic_2_size[BENCHNUM] = {0x11001,99999,0xfff,0xc000,0x10000};

int basic_1_src_offset[BENCHNUM] = {0x10,0x20,0xcc30,0x38,0x3778};
int basic_2_src_offset[BENCHNUM] = {0x81,0x1124,0x65c,0x8,0x888};

int basic_1_dst_offset[BENCHNUM] = {0x10c,0x1124,0x65c,0x8,0x88};
int basic_2_dst_offset[BENCHNUM] = {0x83,0x20,0xcc00,0x38,0x38};
